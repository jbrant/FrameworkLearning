...
public class NeuralPilot {
	...
	public NeuralPilot(NEATNetwork network2, boolean track)
	{
        fuelStats = new NormalizedField(NormalizationAction.Normalize, "fuel", 200, 0, 0.9, 0.1);
        altitudeStats = new NormalizedField(NormalizationAction.Normalize, "altitude", 10000, 0, 0.9, 0.1);
        velocityStats = new NormalizedField(NormalizationAction.Normalize, "velocity", LanderSimulator.TERMINAL_VELOCITY, -LanderSimulator.TERMINAL_VELOCITY, 0.9, 0.1);
